...
L'exécution d'un processus dure un certain temps, avec un début et parfois une �n. Un processus peut être démarré par l'utilisateur ou par un autre processus.
...
![[Pasted image 20251116192149.png]]
...
Le SO permet également de modifier les attributs des fichiers (nom, date de création/modif, type de contenu, taille et emplacement. Aussi, il gère des permissions : autorisations qui indiquent si un utilisateur spécifique peut lire, écrire (modifier) ou exécuter le fichier.

### Installer un OS

Normalement un OS est préinstallé. Mais il est tout à fait possible d’installer nous-même ce système !

Pourquoi faire ?

·        Installer un système différent de celui fourni

·        installer une nouvelle version du même OS

·        réinstaller le OS pour résoudre un bug, ou…

·        en cas de présence d’un virus ; réinstaller le système pour le configurer différemment.

En entreprise, on réinstalle en général systématiquement un OS sur les ordis neufs, car la marque qui vend l’ordi aura toujours des partenariats qui polluent l’ordi. Ça va virer les apps inutiles. Si ça vient d’un autre pays, par ex, mieux réinstaller du neuf pour ne pas se retrouver espionnés.
...
La clé USB d’installation n’est en général pas fournie par l’éditeur du OS. Nous allons devoir la créer nous-mêmes depuis un autre ordi, avec un utilitaire prévu à cet effet et en utilisant une image disque (aussi appelé image ISO). Une image disque est une copie conforme (une « photo ») du contenu d’un disque optique ou magnétique. Il existe différents formats d’images disque, mais le format ISO est le plus utilisé.
...
Il faut une clé USB spéciale pour les BIOS ou n

Je rentre la clé bootable à l’ordi, il va te dire sur quelle touche appuyer pour booter le BIOS, suivre les instructions.
...
[https://fr.wikipedia.org/wiki/Informatique](https://fr.wikipedia.org/wiki/Informatique)
## Les débuts
...
## Ada Lovelace
![[Pasted image 20251116192426.png]]
Date : environ entre 1830 & 1852

Ada Lovelace est une pionnière de l'informatique. D'après Wikipédia : Elle est principalement connue pour avoir réalisé le premier véritable programme informatique, lors de son travail sur un ancêtre de l'ordinateur :
...
![[Pasted image 20251116192459.png]]
## Métier Jacquard

Date : 1801

D'après Wikipédia : Le métier Jacquard est un métier à tisser mis au point par le Lyonnais Joseph Marie Jacquard avec l'aide du menuisier Jean-Antoine Breton en 1801, **premier système mécanique programmable avec cartes perforées**.
## Al-Khwârizmî
![[Pasted image 20251116192546.png]]
Date : environ entre 800 et 850

Le mathématicien a également indirectement contribué à l'informatique moderne ! D'après Wikipédia : Son nom latinisé est à l’origine du mot algorithme et le titre de l'un de ses ouvrages (Abrégé du calcul par la restauration et la comparaison) est à l'origine du mot algèbre. Al-Khwârizmî a classifié les algorithmes existants, en particulier selon leurs critères de terminaison, mais ne les a pas inventés.

[Al-Khwârizmî — Wikipédia](https://fr.wikipedia.org/wiki/Al-Khw%C3%A2rizm%C3%AE)
## Euclide
![[Pasted image 20251116192648.png]]
Date : vers 300 avant JC

En mathématiques, est un algorithme qui calcule le plus grand commun diviseur (PGCD) de deux entiers, c'est-à-dire le plus grand entier qui divise les deux entiers, en laissant un reste nul.

L'algorithme d'Euclide serait l'un des plus anciens algorithmes jamais conçus.
[Algorithme d'Euclide — Wikipédia](https://fr.wikipedia.org/wiki/Algorithme_d%27Euclide)

L'ère moderne : Retour au 20ème siècle !
## Alan Turing
![[Pasted image 20251116192724.png]]
Date : entre 1936 et 1940 environ

Mathématicien et cryptologue, Alan Turing est l'auteur de travaux qui fondent scientifiquement l'informatique, notamment la machine de Turing. Il est aussi l'un des pionniers de l'intelligence artificielle.
...
[Machine de Turing — Wikipédia](https://fr.wikipedia.org/wiki/Machine_de_Turing)
## Machines à calculer
Date : fin des années 1930

Deux premières machines à calculer électromécaniques voient le jour :

• créée par Howard Aiken & Thomas J. Watson + IBM entre 1939 et 1943, puis donnée à l'université Harvard en 1944 [Harvard Mark I — Wikipédia](https://fr.wikipedia.org/wiki/Harvard_Mark_I)

• développée en secret par Konrad Zuse entre 1939 et 1941, détruit pendant la Seconde Guerre mondiale. [Zuse 3 — Wikipédia](https://fr.wikipedia.org/wiki/Zuse_3)

## Premier "ordinateur"
![[Pasted image 20251116192840.png]]
...
## John Von Neumann
![[Pasted image 20251116192925.png]]
Date : 1945
...
## EDVAC
![[Pasted image 20251116193010.png]]
Date : 1946 (lancement du projet) - 1951 (mise en service)

L'[Electronic Discrete Variable Automatic Computer — Wikipédia](https://fr.wikipedia.org/wiki/Electronic_Discrete_Variable_Automatic_Computer) est l'un des tous premiers ordinateurs électroniques. Il opère en binaire, contrairement à l'ENIAC qui opère en décimal.
...
![[Pasted image 20251116193040.png#center]]
• 1949 : Le [BINAC — Wikipédia](https://fr.wikipedia.org/wiki/BINAC), produit par l'entreprise EMCC (première entreprise fabriquant des ordinateurs, premier ordinateur commercialisé)

• 1951 : Le [Ferranti Mark I — Wikipédia](https://fr.wikipedia.org/wiki/Ferranti_Mark_I), premier ordinateur électronique "généraliste" commercialisé

• 1951 : L'[UNIVAC I — Wikipédia](https://fr.wikipedia.org/wiki/UNIVAC_I) , premier ordinateur commercial réalisé aux États-Unis.

## La révolution, une découverte a tout changé

### Le Transistor
![[Pasted image 20251116193149.png]]
Date : 1947

Suite aux travaux sur les [Semi-conducteur — Wikipédia](https://fr.wikipedia.org/wiki/Semi-conducteur), le premier transistor a été réalisé dans les [Laboratoires Bell — Wikipédia](https://fr.wikipedia.org/wiki/Laboratoires_Bell). Les chercheurs à l'origine de cette "découverte" ont reçu le prix Nobel de physique en 1956.
...
• Bell Labs [TRADIC — Wikipédia](https://fr.wikipedia.org/wiki/TRADIC) (1954)

• Lincoln Laboratory [TX-0 — Wikipédia](https://fr.wikipedia.org/wiki/TX-0) (1956)
### Disque dur
![[Pasted image 20251116193519.png#center]]
...
## Circuit intégré
![[Pasted image 20251116193601.png]]
Invention en 1958 par Jack Kilby du première [Circuit intégré — Wikipédia](https://fr.wikipedia.org/wiki/Circuit_int%C3%A9gr%C3%A9).
...
## PDP-8
![[Pasted image 20251116193651.png#center]]
Le [PDP-8 — Wikipédia](https://fr.wikipedia.org/wiki/PDP-8), sorti en mars 1965, est qualifié de "Fort T" de l'informatique : simple, rustique, abordable (moins de 10 000$), et produit en masse.

50 000 exemplaires produits entre 1965 et 1984. Sa mémoire ? À peine plus de 6 octets (4096 mots de 12 bits).

## Micro-processeur
![[Pasted image 20251116193738.png#center]]
En 1969, le [Microprocesseur — Wikipédia](https://fr.wikipedia.org/wiki/Microprocesseur) est inventé par un physicien d'Intel.

Un petit tour sur la page Wikipédia s'impose !

(Photo : un Intel 4004, le premier processeur !)
## Loi de Moore
![[Pasted image 20251116193840.png#center]]
...
![[Pasted image 20251116193937.png#center]]
...
## Datapoint 2200
![[Pasted image 20251116194021.png#center]]
...
On le programme en utilisant un [Téléscripteur — Wikipédia](https://fr.wikipedia.org/wiki/T%C3%A9l%C3%A9scripteur).

R2E a été absorbé par le groupe Bull en 1978.

## Téléscripteur
![[Pasted image 20251116194158.png#center]]
Bel exemple d'une [Téléscripteur — Wikipédia](https://fr.wikipedia.org/wiki/T%C3%A9l%C3%A9scripteur) beaucoup plus fournie en anglais qu'en français.

## Xerox Alto & Star (1973/1981)

[Xerox Alto — Wikipédia](https://fr.wikipedia.org/wiki/Xerox_Alto) : première souris et première interface graphique ! Juste un prototype, mais premier ordi personnel complet au sens moderne.

[Xerox Star — Wikipédia](https://fr.wikipedia.org/wiki/Xerox_Star) : version basée sur le proto, premier vrai ordi personnel complet commercialisé.

## IBM 5100 (1975-1981) :

premier ordi transportable.
![[Pasted image 20251116194740.png]]
1978 : IBM 5110 , plus large public, 5120 écran plus grand [IBM 5100 et 5110 — Wikipédia](https://fr.wikipedia.org/wiki/IBM_5100_et_5110)
...
[Altair 8800 — Wikipédia](https://fr.wikipedia.org/wiki/Altair_8800)
...
[Commodore PET — Wikipédia](https://fr.wikipedia.org/wiki/Commodore_PET)

## TRS-80 (1977)
![[Pasted image 20251116195415.png#center]]
Sorti en 1977, 1,5 millions d'unités vendues.

[TRS-80 — Wikipédia](https://fr.wikipedia.org/wiki/TRS-80)

## TL-99 (1979)
![[Pasted image 20251116195452.png]]
Sorti fin 1979, 2,8 millions vendus.

[TI-99/4A — Wikipédia](https://fr.wikipedia.org/wiki/TI-99/4A)

## Atari 8-bits (1979)
![[Pasted image 20251116195522.png]]
Sorti en novembre 1979.

[Atari 8-bits — Wikipédia](https://fr.wikipedia.org/wiki/Atari_8-bits)

## Sinclair (1970/1980)
![[Pasted image 20251116195552.png]]
Date : fin des années 70 / début 80

[Sinclair Research — Wikipédia](https://fr.wikipedia.org/wiki/Sinclair_Research)
...
[Commodore 64 — Wikipédia](https://fr.wikipedia.org/wiki/Commodore_64)

## Oric-1 & Atmos (1982/83)
![[Pasted image 20251116195700.png]]
L'ordinateur Oric-1, sorti en 1982/83, est le premier ordi à se répandre dans les foyers français & anglais (UK). [Oric — Wikipédia](https://fr.wikipedia.org/wiki/Oric#Oric-1)

Oric Atmos: sorti en 1985. [Oric — Wikipédia](https://fr.wikipedia.org/wiki/Oric#Oric_Atmos)

## Thomson TO7 (1982) & MO5 (1984)
![[Pasted image 20251116195738.png]]
1982 : [Thomson TO7 — Wikipédia](https://fr.wikipedia.org/wiki/Thomson_TO7)

1984 : [Thomson MO5 — Wikipédia](https://fr.wikipedia.org/wiki/Thomson_MO5)
...
1981 : IBM 5150, à base de processeur Intel 8088 [IBM PC — Wikipédia](https://fr.wikipedia.org/wiki/IBM_PC)

1983 : IBM PC XT [IBM PC/XT — Wikipédia](https://fr.wikipedia.org/wiki/IBM_PC/XT)

## Lisa & Apple Macintosh (1983/84)
![[Pasted image 20251116200128.png]]
Lisa 1983 (avec interface graphique) Motorola 68000 1Mo RAM, DD 5Mo 10k$ / 70k francs : [Apple Lisa — Wikipédia](https://fr.wikipedia.org/wiki/Apple_Lisa)

Macintosh 1984, premier succès d'interface graphique WIMP (Windows, Icons, Menus & Pointing device) similaire au Lisa mais à 2495€ 128ko de RAM, pas de disque interne : [Macintosh 128K — Wikipédia](https://fr.wikipedia.org/wiki/Macintosh_128K)

## IBM PS/1 & PS/2 (1987/90)
![[Pasted image 20251116200318.png#center]]
1987 : [IBM Personal System/2 — Wikipédia](https://fr.wikipedia.org/wiki/IBM_Personal_System/2)

1990 : [IBM Personal System/2 — Wikipédia](https://fr.wikipedia.org/wiki/IBM_Personal_System/2)

## IBM compatible
![[Pasted image 20251116200357.png#center]]
[Compaq — Wikipédia](https://fr.wikipedia.org/wiki/Compaq)

#### Fin des années 90, 2000 & de nos jours, tout commence à exploser en évolution, niveau hardware et software.

[Compatible PC — Wikipédia](https://fr.wikipedia.org/wiki/Compatible_PC), informatique embarquée & miniaturisation…
