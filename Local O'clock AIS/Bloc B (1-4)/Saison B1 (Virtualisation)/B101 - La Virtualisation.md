Cours du 05-01-2026
![[Pasted image 20260105101838.png]]
...
![[Pasted image 20260105101957.png]]
Cette technique permet d'accroître l'efficacité de l'utilisation du matériel informatique, de réduire les coûts d'exploitation et d'améliorer la flexibilité et la gestion des systèmes informatiques.

La virtualisation joue un rôle crucial dans l'évolution des technologies de l'information, en particulier dans le contexte du cloud computing.
...
- Les années 1990 ont vu l'émergence de solutions de virtualisation commerciales comme VMware Workstation et Microsoft Virtual PC.
...
**Un hyperviseur**, également connu sous le nom de moniteur de machine virtuelle, est le logiciel qui gère cette abstraction.
...
![[Pasted image 20260105102042.png]]
...
![[Pasted image 20260105102140.png]]
...
![[Pasted image 20260105102315.png]]
### Microsoft Hyper-V
...
**! Hyperviseur de type 1**.
![[Pasted image 20260105102340.png]]
...
![[Pasted image 20260105102405.png]]
### Citrix XenServer
...
**Hyperviseur de type 1**.
![[Pasted image 20260105102514.png]]
### Proxmox VE
...
![[Pasted image 20260105102545.png]]
**Définition** :
...
La virtualisation du réseau permet de créer des réseaux virtuels gérés de manière centralisée, facilitant la configuration et offrant une meilleure isolation des flux de données (pfsense sur proxmox).
...
![[Pasted image 20260105105001.png]]
## Virtualisation des applications
...
![[Pasted image 20260105105812.png]]
## Virtualisation du stockage
...
Le SAN (Storage Area Network) connecte les serveurs à des dispositifs de stockage via un réseau dédié, **offrant une infrastructure de stockage** centralisée et flexible. Il permet une

gestion centralisée des ressources de stockage et une meilleure isolation des flux de données, ce qui facilite la gestion des données.
...
Le NAS (Network Attached Storage) fournit un accès aux données aux serveurs via le réseau local, permettant un partage de fichiers simplifié et une gestion centralisée du stockage.
...
![[Pasted image 20260105111024.png]]
...
[https://www.linkedin.com/pulse/cest-quoi-la-virtualisation-des-r%C3%A9seaux-academy-zegus/](https://www.linkedin.com/pulse/cest-quoi-la-virtualisation-des-r%C3%A9seaux-academy-zegus/)
...
## Architecture
![[Pasted image 20260105114308.png]]
## Fonctionnalités
...
- Copier-coller entre hoôte et VM
...
Exemple de site pour faire des analyses des VM prêtes à être cassées et avec les analyses [https://app.any.run/](https://app.any.run/)
...
#### Architecture
![[Pasted image 20260105131730.png]]
**Proxmox VE**
...
![[Pasted image 20260105135505.png]]
